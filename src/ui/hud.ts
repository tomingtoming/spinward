...
const CONTROLS_TEXT =
  'PC - WASD: walk / fly | click: throw | Space: jump | Shift: ascend | Ctrl: descend | Q/E: roll | B: roll brake | 1/2/3: travel | F: launch | right-drag/arrows: look | Tab: menu | E: drive (near the car) | M: mute\n' +
