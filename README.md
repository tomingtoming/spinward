...
- ヒーロー街区のうち近景 180m では、Blender 製の**店舗シャッター・ガラス店舗・自販機・室外機/配管・自転車・プランター路地**を実在する道路側の建物前だけに最大96組配置します。LOD0 と一緒に消える6バッチの InstancedMesh とし、遠景へ細物をばらまかず日本の街路密度を出します。
